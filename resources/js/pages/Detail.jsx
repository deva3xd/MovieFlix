        ...
        <MainLayout title={detail.title || detail.name}>
                    ...
                    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row gap-4 text-white">
                        <div className="w-1/2 flex flex-col gap-3">
                            ...
                            <div className="text-gray-400 flex items-center gap-2 text-sm">
                                ...
                                <span className="text-white/80 text-lg font-bold">{voteAverage}</span>
            ...
            <div className="max-w-7xl mx-auto px-4 mt-8">
                <div className="flex items-center justify-between">
                    <h3 className="text-lg sm:text-2xl font-bold text-white">Cast</h3>
                ...
                <div className="mt-8">
                    ...
                    <div className="flex gap-2 overflow-x-scroll w-full my-2">
