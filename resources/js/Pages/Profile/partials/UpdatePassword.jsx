    ...
    return (
        ...
        <>
            ...
            <fieldset className="fieldset">
                ...
                <input type="text" className="input w-full focus:outline-none" placeholder="current password" />
            </fieldset>
            <fieldset className="fieldset mt-3">
                <legend className="fieldset-legend">New Password</legend>
                <input type="text" className="input w-full focus:outline-none" placeholder="new password" />
            </fieldset>
            <fieldset className="fieldset mt-3">
                <legend className="fieldset-legend">Confirm Password</legend>
                <input type="text" className="input w-full focus:outline-none" placeholder="confirm password" />
            </fieldset>
